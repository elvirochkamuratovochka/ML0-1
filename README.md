...
Ковариационные матрицы классов равными, даже если они на самом деле не равны. В таком случае достаточно оценить только одну ковариационную матрицу Σ, задействовав для этого все ℓ обучающих объектов.  В данном случае разделяющая поверхность является линейной, а ее коэффициенты находятся из оптимального байесовского решающего правила: 
