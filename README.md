...
Допустим, что признаки <img src="http://1.618034.com/blog_data/math/formula.48025.png" width="70"> - независимые случайные величины с плотностями распределения, <img src="http://1.618034.com/blog_data/math/formula.48028.png" width="100">.

Тогда функции правдоподобия классов представимы в виде произведения одномерных плотностей по признакам: 
<img src="http://1.618034.com/blog_data/math/formula.48031.png" width="120">
