...
Параметр *h* называется шириной окна и играет примерно ту же роль, что и число соседей *k*. Параметр *h* можно задавать или определять по скользящему контролю (LOO). 
