...
Допустим, что ковариационные матрицы классов равными. В таком случае достаточно оценить только одну ковариационную матрицу Σ, задействовав для этого всю выборку целиком.  В данном случае разделяющая поверхность является линейной, а ее коэффициенты находятся из оптимального байесовского решающего правила: 

<img src="http://1.618034.com/blog_data/math/formula.54528.png" width="600">
